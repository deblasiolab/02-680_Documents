...
\title{Topic 17: Graphical Representations of Random Variables}
...
\[p\Big(\left\langle Q_1, Q_2, ..., Q_d\right\rangle\Big) = \prod_{i=1}^d\; p\!\left(Q_i \middle| \bigwedge_{j \in N^{in}(Q_i)} Q_j\right)\]
