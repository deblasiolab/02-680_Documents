...
\title{Topic 14: Conditional Probability and Bayes' Rule}
...
p(A\cap B|C) &= \frac{1}{4} &\quad p(A\cap B|\overline{C}) &= 1\\
&p(C) &= p(\overline{C}) = \frac{1}{2}
\end{alignat*}
...
\begin{itemize}
\item[] Prior: $p(A)=0.05$ (background probability that you have the flu regardless of symptoms)
\item[] Likelihood:
\begin{itemize} 
