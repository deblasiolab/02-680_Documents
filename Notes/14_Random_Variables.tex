...
\[p(k) = \begin{cases}\frac{1}{b-a} & a \le k \le b\\0 & \text{othwerwise}\end{cases}\]
...
\[(pX\le x) = \int_{-\infty}^x  \frac{1}{\sigma\sqrt{2\pi}}\;\;e^{\frac{(x-\mu)^2}{-2\sigma^2}} dx\]
