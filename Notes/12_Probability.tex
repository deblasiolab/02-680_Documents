...
For \textit{disjoint} events $A_1, A_2, ..., A_n$, \[p(A_1\cup A_2\cup ... \cup A_n)=p(A_1) + p(A_2) + ... + p(A_n).\]
...
We also know $p(\overline{A})\ge 0$ from axiom 1. (or really  $-1\times p(\overline{A})\le 0$)
...
Frequentists are very objective in the explanation of things. 
