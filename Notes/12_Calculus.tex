...
\section{Derivatives}
 ...
 \begin{itemize}
 \item the derivative $\displaystyle\frac{df}{dx}$ is the change in value of $f$ as you increase/decrease $x$.
...
What we've described here is a slight simplification of \emph{gradient descent} first described by Cauchy in the 1847. 
...
\[Ax=b\]
where $A\in\reals^{m\times n}$, and $b\in\reals^m$.
...
So any function $g: \reals^n\mapsto\reals^m$ with $m,n\in\ints^{\ge2}$.
We say the \emph{Jacobian} of $g$ is 
\[J_g(x) = \begin{bmatrix}
\frac{\partial g_1}{\partial x_1} & \frac{\partial g_1}{\partial x_2} & \hdots & \frac{\partial g_1}{\partial x_n} \\  
\frac{\partial g_2}{\partial x_1} & \frac{\partial g_2}{\partial x_2} & \hdots & \frac{\partial g_2}{\partial x_n} \\  
\vdots & \vdots & \ddots & \vdots\\
\frac{\partial g_m}{\partial x_1} & \frac{\partial g_m}{\partial x_2} & \hdots & \frac{\partial g_m}{\partial x_n} \end{bmatrix}\]
...
\multirow{2}{*}{exponent rules} & \[\frac{d}{dx}\left(e^{g(x)}\right) = e^{g(x)}g'(x)\]\\
 ...
 log rule & \[\frac{d}{dx}\left(\log_c g\left(x\right)\right) = \frac{g'(x)}{g(x)\ln c}\]\\\hline
...
\multirow{2}{*}{exponent rules} & \[\int e^{x} dx = e^{x}+c\]\\
 & \[\int a^x dx = \frac{a^x}{\ln a} + c\]\\\hline
