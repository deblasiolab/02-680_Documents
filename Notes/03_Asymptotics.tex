...
\]
\[
o\big(g\left(x\right)\big) := \bigg\{h(x) \biggm| \exists x_0 \ge 0, c > 0 : \forall x \ge x_0 : h(x) < c \cdot g(x) \bigg\}  := \bigg\{h(x) \biggm| h(x) \in O( g(x)) \wedge h(x) \notin \Omega(g(x)) \bigg\}
\]
\[
\omega\big(g\left(x\right)\big) := \bigg\{h(x) \biggm| \exists x_0 \ge 0, c > 0 : \forall x \ge x_0 : h(x) > c \cdot g(x) \bigg\}  := \bigg\{h(x) \biggm| h(x) \notin O( g(x)) \wedge h(x) \in \Omega(g(x)) \bigg\}
\]
