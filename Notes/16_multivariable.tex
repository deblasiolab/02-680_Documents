...
\title{Topic 16: Multiple Random Variables}
...
If we want to determine, say $P(X=\texttt{Tails})$, it turns out we can sum over all the possibilities of $Y$: 
...
$G_1$ & $G_2$ & $p(C=\texttt{Y}\mid G_1,G_2)$\\
\hline\hline
