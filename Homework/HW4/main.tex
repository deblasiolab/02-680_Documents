...
HW4: Probability \& Applied Statistics - [andrew-id]\\ \\
{\small\em Version: 1\\Due: 23:59 EST, December 7, 2023 on Gradescope\\
}
}
...
\newpage
\begin{enumerate}
\item \input{Q_probability_distributions}\clearpage
\item \input{Q_estimation}\clearpage
\item \input{Q_multivariate}\clearpage
\item \input{Q_hypothesis_testing}
\end{enumerate}
%\newpage
%\pagestyle{empty}
