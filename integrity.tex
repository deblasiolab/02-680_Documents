...
%You should not use AI tools to generate any content 
...
To best support your own learning 
(remember this course builds the quantitative foundation the rest of your program assumes you have) 
you must complete all graded work in this course entirely on your own, without the use of generative artificial intelligence (AI). 
This is a blanket policy: it applies to every graded assignment and classroom exercise, including homework, quizzes, and exams, with no exceptions.

You may not use AI tools to generate any content
(text, code, derivations, proofs, explanations, or any other material) that you then submit as your own work. 
Cutting and pasting AI-generated content into an assignment, or paraphrasing it before submitting, is a violation of CMU's Academic Integrity Policy, 
exactly as if the material had come from another student or an uncredited outside source. 
(This policy covers generative AI tools such as ChatGPT, Claude, Copilot, and Gemini — it does not cover ordinary calculators or non-generative computational tools.)

Using AI as a study aid is encouraged. You're welcome to use generative AI, including the course's shared NotebookLM, 
to help you understand concepts, work through confusion while studying, or explore the material from a different angle. 
The line is between using AI to learn the material and using it to produce the work you submit for a grade:
 the first is fine, the second is not, no matter how you use, phrase, or rework the output.

If you're ever unsure whether a particular use crosses that line, ask before you use it, not after.

Suspected violations will be handled under CMU's Academic Integrity Policy\footnote{\url{https://www.cmu.edu/policies/student-and-student-life/academic-integrity.html}}.
